...
def init():
	...
	with getCur() as cur:
                ...
                cur.execute("CREATE TABLE IF NOT EXISTS Scores(Id INTEGER PRIMARY KEY AUTOINCREMENT, GameId INTEGER, PlayerId INTEGER, Rank TINYINT, Score INTEGER, Date DATE,\
