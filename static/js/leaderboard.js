...
/*		      console.log('Attaching click event handle to ordering')*/
	...
	$(".leaderboard").each(function (i, board) {
	    ...
	    var last_place = 0;
/*	    console.log("Updating '" + boardname + "' scores with min games "
			+ min_games + " and rank_visible " + rank_visible); */
	...
	if (i < 0) { i = 0 };
/*	console.log('Set ordering from ' + currenttext + ' to ' +
		    orderings[1 - i]); */
